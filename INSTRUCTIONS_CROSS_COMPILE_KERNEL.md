...
kernel configuration however in most cases no changes will need to be made.
...
The process should complete with a message similar to the following
    ...
    Created:      Fri Sep 10 08:43:30 2021
    Image Type:   ARM Linux Kernel Image (uncompressed)
    Data Size:    3857960 Bytes = 3767.54 KiB = 3.68 MiB
